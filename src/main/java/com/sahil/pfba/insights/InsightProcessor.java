...
public class InsightProcessor {
    ...
    public InsightProcessor(ExpenseService expenseService,InsightRepository insightRepository, List<InsightRule> insightRules,LLMClient llmClient){
    ...
    @Transactional
    public void generateInsightsTransactional() {
