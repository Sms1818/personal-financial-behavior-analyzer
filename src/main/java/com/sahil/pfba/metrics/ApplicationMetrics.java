...
public class ApplicationMetrics {
    ...
    public ApplicationMetrics(MeterRegistry meterRegistry){
        this.expenseCreatedCounter=
            Counter.builder("pfba.expense.created")
                    .description("Total expense created")
                    .register(meterRegistry);
            
                    this.csvUploadCounter =
                    Counter.builder("pfba.csv.upload")
                            .description("CSV uploads")
                            .register(meterRegistry);
    
            this.insightGeneratedCounter =
                    Counter.builder("pfba.insight.generated")
                            .description("Insights generated")
                            .register(meterRegistry);
    
            this.loginSuccessCounter =
                    Counter.builder("pfba.auth.login.success")
                            .register(meterRegistry);
    
            this.loginFailureCounter =
                    Counter.builder("pfba.auth.login.failure")
                            .register(meterRegistry);
    
            this.insightGenerationTimer =
                    Timer.builder("pfba.insight.generation.time")
